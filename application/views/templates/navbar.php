    ...
    <div class="navbar-custom-menu">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown user user-menu">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            <img src="<?php echo base_url('/assets/img/profile/') ?><?php echo $this->session->userdata('image') ?>" class="user-image" alt="User Image">
            <span class="hidden-xs"><?php echo $this->session->userdata('email') ?></span>
          </a>
          <ul class="dropdown-menu">
            <!-- User image -->
            <li class="user-header">
              <img src="<?php echo base_url('/assets/img/profile/') ?><?php echo $this->session->userdata('image') ?>" class="img-circle" alt="User Image">

              <p>
                <?php echo $this->session->userdata('email') ?>
                <small><?php echo $this->session->userdata('name') ?></small>
                <small>Member since <?php echo $this->session->userdata('date_created') ?></small>
              </p>
            </li>
